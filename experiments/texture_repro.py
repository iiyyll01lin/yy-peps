...
PROTOCOL_ASSUMPTIONS = (
    ...
    },
    {
        ...
        "detail": (
            "The 3F/4F sweep times checkpoint inference in PyTorch. It records "
            "real local latency but is not comparable to the paper's fused HIP/"
            "WMMA three-channel decoder."
        ),
    },
    {
