...
NB = {
    "cells": [
        ...
        md(
            ...
            "optimises one absolute global L1. A detail one level below the reported",
            "recipe moves the headline effect far more than any budget change we",
            "measured. Table 2 is not mis-specified here, since all 594 jobs share",
            "the same reduction, but it shows where to look first: rank candidate",
            "causes by measured sensitivity before spending GPU time.",
            "",
