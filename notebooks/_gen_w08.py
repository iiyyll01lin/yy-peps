...
NB = {
    "cells": [
        ...
        md(
            ...
            "family where the paper does the reverse. The reduction does explain",
            "that. Holding everything else fixed and sweeping only the exponent,",
            "`NTC_PEPS` minus `BI-Grid` runs -0.0709, +0.3680, +2.0044 dB for",
            "exponents 0, 0.5 and 1, so the sign flips and the published +0.540 is",
            "bracketed. See `results/texture_repro/ordering_probe/`. That is",
            "sufficiency, not necessity: another unreported choice could do it too.",
            "",
